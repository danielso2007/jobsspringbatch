package com.springbatch.parallelsteps.batch.reader;
...
import com.springbatch.parallelsteps.code.dominio.DadosBancarios;
...
public class ArquivoDadosBancariosReaderConfig {
    ...
    public FlatFileItemReader<DadosBancarios> dadosBancariosReader() {
        return new FlatFileItemReaderBuilder<DadosBancarios>().name("dadosBancariosReader")
                ...
                .names("pessoaId", "agencia", "conta", "banco", "id").addComment("--").targetType(DadosBancarios.class)
                .build();
    }
}
