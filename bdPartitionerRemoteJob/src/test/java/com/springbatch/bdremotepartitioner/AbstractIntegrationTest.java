...
@SpringBootTest(classes = BdPartitionerRemoteJobApplicationTests.class, webEnvironment = WebEnvironment.RANDOM_PORT, properties = {
        "spring.datasource.url=jdbc:tc:postgres:16.2-alpine3.19:///migracao_dados3" })
@ActiveProfiles("test")
