package com.springbatch.processamentoassincrono;
...
@SpringBootTest(classes = ProcessamentoAssincronoApplicationTests.class, webEnvironment = WebEnvironment.RANDOM_PORT, properties = {
